...
const FUDA = 
  ...
  '山里は。 冬ぞさびしさ　まさりける。　人目mo草mo　かれぬと思へば',
  '心あてに。　折らばや折らん　初しもの。 沖窓、早生る　白菊の花',
  '有明の。 つれなく見えし　別れより。　あかつきばかり　うき者はなし',
  ...
  '和酢ららる。　身をば思はず　ちかひてし。　人の命の　惜しくもあるカナ',
  ...
  '風をいたみ。 岩うつなみの　おのれのみ。 くだけてものを　思うころカナ',
  'みかきもり。 えじのたくひの　夜は燃え。 昼は消えつつ。　物をこそ思へ',
  '君がため。 惜しから座らし　命さえ。　長くもがなと。　思ひけるカナ',
  ...
  '阿良皿ん。　この世のほかの　思ひ出に。　今ひとたびの。　あうこともがな',
  'めぐりあいて。　見しやそれとも　湧かぬまに。　雲がくれにし。　余波の月かな',
  '有馬山。 いなのささはら　風吹けば。 いで曽世ヒトを。　忘れやはする',
  'やすらわで。 寝ナマしものを　さよふけて。 かたぶくまでの　月を見しカナ',
  '大江山。 いく野の道の。　遠ければ。　まだふみもみず　あまの橋立',
  'いにしへの。 奈良のみやこの　八重桜。　今日ここの絵に　においぬるカナ',
  'よを込めて。　鳥のそらねは　はかるTomo。　世に大阪の　咳わユル匙',
  '今はただ。　思ひ絶えなん　とばかりを。　人づてならで。　言ふよしもガナ',
  ...
  '瀬を早見。　岩にせかるる。　滝川の。　われても末に。　あわんとぞ思う',
...
class CEKRequest {
  ...
  launchRequest(cekResponse) {
    ...
    if (typeof cached === 'undefined') {
      ...
      cekResponse.appendSpeechText("次、または、もう一度といひたまへ。")
    }
