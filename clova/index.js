...
const FUDA = 
  ...
  ['ウカリける。　人をはつせの　山おろしよ。','　　はげしかれとは、　祈らぬものを'],
  ['ちぎりおきし。　させもがつゆを　命にて。','　　あはれ今年の、　秋もイヌメり'],
  ['わたノハRA。　漕ぎいでて見れば。　ひさかたの。　','　くもいにまがう、　沖つ白波'],
  ...
  ['なげけとて。　月や和ものを　思はする。　','　かこち顔なる、　わが涙カナ'],
...
class CEKRequest {
  ...
  intentRequest(cekResponse) {
    ...
    case 'PinpointIntent':
      ...
      cekResponse.appendSpeechText(FUDA[index][0])
      cekResponse.appendSpeechText(FUDA[index][1])
      break;
    case 'NextIntent':
      if (index >= 99){
        cekResponse.appendSpeechText({
